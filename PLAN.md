...
- likely continue with the next typed slice from `plugin-redoc-2.yaml`, such as pull-review comment resolve/unresolve operations, commit-status endpoints, or a small repository-management endpoint,
