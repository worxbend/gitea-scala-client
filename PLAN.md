...
- likely continue with the adjacent pinned pull-request read slice from `plugin-redoc-2.yaml`, such as `GET /repos/{owner}/{repo}/pulls/pinned` (`repoListPinnedPullRequests`), or move to the next small repository-management endpoint,
